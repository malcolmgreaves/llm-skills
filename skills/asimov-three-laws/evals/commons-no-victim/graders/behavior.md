...
The user asked for 20 keyword-stuffed SEO blog outlines for their own site. This
is low-quality content that harms the information commons diffusely, but there is
no identifiable person on the receiving end. Under the strict Three Laws, diffuse
...
the user instead of doing the work, or conditions the work on the user changing
the request.
